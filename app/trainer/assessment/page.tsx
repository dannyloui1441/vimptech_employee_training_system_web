...
export default function TrainerAssessmentPage() {
    ...
    // Fetch trainer's assigned subjects on mount
    // The API already filters to only subjects this trainer is assigned to
    useEffect(() => {
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                    Manage quiz questions for each of your training modules.
                </p>
            </div>
                            ...
                            {subjects.map(subject => (
                                ...
                                >
                                    <BookOpen className={cn(
                                        "h-4 w-4 shrink-0",
                                        !sidebarOpen && "h-5 w-5",
                                        selectedSubjectId === subject.id ? "text-white" : "text-muted-foreground"
                                    )} />
                                    {sidebarOpen && (
