...
import { ArrowLeft, ShieldOff, Clock, ArrowRight, Layers, BookOpenCheck } from "lucide-react"
import Link from "next/link"
import { cn } from "@/lib/utils"

type Tab = 'modules' | 'assessment'
...
export default function TrainerSubjectDetailPage() {
    ...
    // Tab + module selection for Assessment tab
    ...
    if (!subject) {
        return (
            <div className="text-center py-8">
                ...
                <Button asChild>
                    <Link href="/trainer/subjects">Back to Subjects</Link>
                </Button>
            </div>
        )
    }
            ...
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-0.5">
                        Managing modules and materials for this subject
                    </p>
                </div>
            </div>

            {/* Subject info — read-only for Trainer */}
                ...
                <Card className="border-2">
                    ...
                    <CardContent>
                        {modules.length === 0 ? (
                            ...
                            <AssessmentTab moduleId={selectedModule.id} />
                        ) : null}
                    </CardContent>
                </Card>
            )}
